...
//makes an object of the Forward class
  ...
  public Command getAutonomousCommand() {
    ...
    return new WaitCommand(5.0).andThen(new PIDInches(m_romiDrivetrain, 30.5)).andThen(m_Turn90Degrees).andThen(new PIDInches(m_romiDrivetrain, 48)).andThen(m_TurnNegative90Degrees).andThen(new PIDInches(m_romiDrivetrain, 24)).andThen(m_Turn90Degrees).andThen(new PIDInches(m_romiDrivetrain, 50));
  }
}